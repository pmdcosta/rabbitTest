...
if [ -z "$DEVELOPMENT" ]; then
        ...
        /opt/rabbitmq/sbin/rabbitmqctl set_permissions -p production gateway "^(gateway|reports|disconnects|mqtt*)$" "^(gateway|reports|disconnects|mqtt*)$" ""
else
	...
	/opt/rabbitmq/sbin/rabbitmqctl set_permissions -p development gateway "^(gateway|reports|disconnects|mqtt*)$" "^(gateway|reports|disconnects|mqtt*)$" ""
fi
